...
public class EnderecoRepository {
    ...
    public Endereco create(Endereco endereco){
        ...
        endereco.setIdPessoa(endereco.getIdPessoa());
    ...
    public Endereco update(Integer id, Endereco enderecoAtualizar) throws RegraDeNegocioException {
        Endereco enderecoCRUD = listaEnderecos.stream()
                .filter(endereco -> endereco.getIdEndereco().equals(id))
                .findFirst()
                .orElseThrow(() -> new RegraDeNegocioException("Endereço não encontrado"));
        enderecoCRUD.setIdPessoa(enderecoAtualizar.getIdPessoa());
        enderecoCRUD.setCep(enderecoAtualizar.getCep());
        enderecoCRUD.setNumero(enderecoAtualizar.getNumero());
        return enderecoCRUD;
    }

    public Endereco delete(Integer id) throws RegraDeNegocioException {
        Endereco enderecoCRUD = listaEnderecos.stream()
                .filter(endereco -> endereco.getIdEndereco().equals(id))
                .findFirst()
                .orElseThrow(() -> new RegraDeNegocioException("Endereço não encontrado"));
        listaEnderecos.remove(enderecoCRUD);
        return enderecoCRUD;
    }
