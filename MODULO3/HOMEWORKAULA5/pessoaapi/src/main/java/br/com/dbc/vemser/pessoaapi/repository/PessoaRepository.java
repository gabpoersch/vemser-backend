...
public class PessoaRepository {
    ...
    public Pessoa update(Integer id,Pessoa pessoaAtualizar) throws RegraDeNegocioException {
        Pessoa pessoaCRUD = listaPessoas.stream()
                .filter(pessoa -> pessoa.getIdPessoa().equals(id))
                .findFirst()
                .orElseThrow(() -> new RegraDeNegocioException("Pessoa não econtrada"));
        pessoaCRUD.setCpf(pessoaAtualizar.getCpf());
        pessoaCRUD.setNome(pessoaAtualizar.getNome());
        pessoaCRUD.setDataNascimento(pessoaAtualizar.getDataNascimento());
        return pessoaCRUD;
    }
    ...
    public Pessoa delete(Integer id) throws RegraDeNegocioException {
        Pessoa pessoaCRUD = listaPessoas.stream()
                ...
                .findFirst()
                .orElseThrow(() -> new RegraDeNegocioException("Pessoa não econtrada"));
        listaPessoas.remove(pessoaCRUD);
        return pessoaCRUD;
    }
