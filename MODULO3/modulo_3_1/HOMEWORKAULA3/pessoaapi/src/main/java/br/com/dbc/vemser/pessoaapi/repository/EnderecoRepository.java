...
public class EnderecoRepository {
    ...
    public EnderecoRepository() {
        ...
        listaEnderecos.add(new Endereco(COUNTER.incrementAndGet(), 2, 99001, 22));
        listaEnderecos.add(new Endereco(COUNTER.incrementAndGet(), 3, 99001, 33));
        listaEnderecos.add(new Endereco(COUNTER.incrementAndGet(), 4, 99001, 44));
        listaEnderecos.add(new Endereco(COUNTER.incrementAndGet(), 5, 99001, 55));
        listaEnderecos.add(new Endereco(COUNTER.incrementAndGet(), 6, 99001, 66));
    }
